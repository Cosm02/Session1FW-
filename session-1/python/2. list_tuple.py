...
list_new = [[2,4,5],[5,6,7],[10 ,69,97]]
element = list_new[2][1]
print("accesing an element: ",element)
list_new[2][1]=666
print(list_new)
print("itering list")
for i,row in enumerate(list_new):
    for j,value in enumerate(row):
        print(f"{i+1}, {j+1} value is : {value}")
...
# Write your code below:
sigma_tuple = ("amirul",24,True,3.25)
sigma_tuple2 = ("Kayes",25,True,3.35)
dictorary = {
    "x1" : sigma_tuple,
    "x2" : sigma_tuple2
}
retrieved_value = dictorary["x1"]
print(retrieved_value);
print(f"{retrieved_value[0]} is {retrieved_value[1]} years old and his cg is {retrieved_value[2]} and he is unmarried{retrieved_value[3]}")
print(f"{sigma_tuple[0]} is unmarried: ",sigma_tuple[2])
print(f"cg of {sigma_tuple[0]} : {sigma_tuple[3]}")
