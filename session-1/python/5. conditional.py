...
# Write your code below:
correct_username = "amirulkayes"
correct_password = "password6251"
...
weather = input("Enter the weather condition (sunny, cloudy, rainy, snowing): ").lower()
...
if temperature > 25:
    if weather == "sunny":
        ...
        print("Stay home, it's not a good day for outdoor activities.")
elif 0 <= temperature <= 25:
    if weather == "sunny":
        print("It's a perfect day for a stroll or light outdoor activity.")
    elif weather == "cloudy":
        print("A good day to relax at home or indoors.")
    elif weather == "rainy":
        print("It's a stay-home day, maybe enjoy a hot drink!")
    else:
        print("Stay home, it's snowing!")
else:
    if weather == "snowing":
        print("It's a skiing day!")
    else:
        print("Stay home, it's too cold for outdoor activities.")
